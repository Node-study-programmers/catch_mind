...
const AuthPage = () => {
  ...
  return (
    <div
      ...
      <div className="flex flex-col border h-screen justify-center items-center bg-white min-w-[400px] w-1/4 max-lg:w-[50%]">
        <div className="flex justify-around w-full mt-10 p-5 border-t-2">
          <p
            className={`font-titleW cursor-pointer pb-1 ${
              select === "join" ? "border-b-2 border-black" : ""
            }`}
          ...
          <p
            className={`font-titleW cursor-pointer pb-1 ${
              select === "login" ? "border-b-2 border-black" : ""
            } `}
